...
func (tx *Tx) init() {
	tx.LogRecord = NewLogRecordClient(tx.config)
	tx.LogSchema = NewLogSchemaClient(tx.config)
}
...
// applies a query, for example: LogRecord.QueryXXX(), the query will be executed
